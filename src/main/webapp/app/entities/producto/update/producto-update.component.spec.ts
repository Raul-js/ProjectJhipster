  ...
  describe('Producto Management Update Component', () => {
    ...
    describe('ngOnInit', () => {
      it('Should call Carrito query and add missing value', () => {
        ...
        const carritos: ICarrito[] = [{ id: 9598 }];
        producto.carritos = carritos;

        const carritoCollection: ICarrito[] = [{ id: 46460 }];
      ...
      it('Should call TipoProducto query and add missing value', () => {
        const producto: IProducto = { id: 456 };
        const tipoproducto: ITipoProducto = { id: 3996 };
        producto.tipoproducto = tipoproducto;

        const tipoProductoCollection: ITipoProducto[] = [{ id: 39068 }];
      ...
      it('Should update editForm', () => {
        const producto: IProducto = { id: 456 };
        const carritos: ICarrito = { id: 285 };
        producto.carritos = [carritos];
        const tipoproducto: ITipoProducto = { id: 8157 };
        producto.tipoproducto = tipoproducto;
